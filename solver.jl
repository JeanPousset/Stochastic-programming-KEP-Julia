...
function solve_KEP(test::KEP_test; verb::Int64=-1)
    ...
    selected_cycles, n_transfert_integer = integer_solution(C_K, test.G, n_transferts_relax, verb)

    return selected_cycles, n_transferts_relax, n_transfert_integer
...
"""
function column_generation_ILP(G::SimpleDiGraph, K::Int64, init_choice::String, SP_method::String, SP_order::String, max_iter::Int64, verb::Int64)::Tuple{Vector{Vector{Int64}},Int64}
